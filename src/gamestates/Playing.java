...
public class Playing extends State implements Statemethods {
	...
	//Ship will be drawn here.  It's like the player arrived on a boat.
	//We can have it on more levels by adding a value for objects when creating the level from lvlImgs
	//Just like any other object
	//Then play with the position values so it looks good where you put it.
	...
	public Playing(Game game) {
		...
		backgroundImg = LoadSave.GetSpriteAtlas(LoadSave.PLAYIING_BG_IMG);
	...
	private void loadDialogue() {
		...
		//This is a simple way of avoiding ConcurrentWorldModificationException error.
	...
	public void addDialogue(int x, int y, int type) {
		//Not adding a new one, just recycling.
	...
	public void draw(Graphics g) {
		...
		if (drawShip)
			g.drawImage(shipImgs[shipAni], (int) (100 * Game.SCALE) - xLvlOffset, (int) ((228 * Game.SCALE) + shipHeightDelta), (int) (78 * Game.SCALE), (int) (72 * Game.SCALE), null);
	...
	public void keyPressed(KeyEvent e) {
		...
		//how much your character moves
		//depends on what button you press	
		case KeyEvent.VK_A:
			player.setLeft(true);
			break;	
		case KeyEvent.VK_D:
	...
	public void keyReleased(KeyEvent e) {
		...
		//this will become the direction your
