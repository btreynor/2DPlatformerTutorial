...
public class Player extends Entity {
	...
	public void render(Graphics g, int lvlOffset) {       
		//getting little man and setting his dimensions
...
//			return;
		...
		//this is to make sure that when you release
		//a directional button but are holding another
	...
	//we want to move so the hit-box is hitting the wall
