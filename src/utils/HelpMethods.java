...
public class HelpMethods {
	...
	//this method is to determine where little man can move and not move
	...
	//method to determine the boundaries that are solid
	...
	public static boolean IsEntityInWater(Rectangle2D.Float hitbox, int[][] lvlData) {
		//will only check if entity touch top of water.  can't reach bottom water
		//if you haven't touched the top
	...
	public static boolean IsSightClear(int[][] lvlData, Rectangle2D.Float enemyBox, Rectangle2D.Float playerBox, int yTile) {
		...
		//old method would return false because the player x is not on edge
